...
function GetDescriptionPIVE() {
    ...
    switch (category) {
        case '0':
            description.push('0 - показывает, что электрооборудование является взрывозащищенным для взрывоопасных смесей всех категорий (1, 2, 3, 4; по ГОСТ - IIA, IIB, IIC)');
            break;
        case '1':
            description.push('1 - наивысшая категория взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. 1 категории; по ГОСТ - IIA)');
            break;
        case '2':
            description.push('2 - наивысшая категория взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. категорий 1, 2; по ГОСТ - IIA)');
            break;
        case '3':
            description.push('3 - наивысшая категория взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. категорий 1, 2, 3; по ГОСТ - IIA, IIB)');
            break;
        case '4':
            description.push('4 - наивысшая категория взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. категорий 1, 2, 3, 4; по ГОСТ - IIA, IIB, IIC)');
            break;
        case 'М':
            description.push('М - второй вид взрывозащиты: "Масляное заполнение оболочки с токоведущими частями". Электрооборудование является взрывозащищенным для взрывоопасных смесей всех категорий (1, 2, 3, 4; по ГОСТ - IIA, IIB, IIC)');
            break;
        case 'П':
            description.push('П - второй вид взрывозащиты: "Заполнение или продувка оболочки под избыточным давлением защитным газом". Электрооборудование является взрывозащищенным для взрывоопасных смесей всех категорий (1, 2, 3, 4; по ГОСТ - IIA, IIB, IIC)');
            break;
        case 'Н':
            description.push('Н - второй вид взрывозащиты: "Повышенная надежность против взрыва (защита вида "е")". Электрооборудование является взрывозащищенным для взрывоопасных смесей всех категорий (1, 2, 3, 4; по ГОСТ - IIA, IIB, IIC)');
            break;
        default:
            ShowError();
            return;
    ...
    var group = mark.substring(2, 3);
    switch (group) {
        case 'А':
            description.push('А - наивысшая группа взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. группы А; по ГОСТ - Т1)');
            break;
        case 'Б':
            description.push('Б - наивысшая группа взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. групп А, Б; по ГОСТ - Т1, Т2)');
            break;
        case 'Г':
            description.push('Г - наивысшая группа взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. групп А, Б, Г; по ГОСТ - Т1-Т4)');
            break;
        case 'Д':
            description.push('Д - наивысшая группа взрывоопасной смеси, для которой электрооборудование является взрывозащищенным (для в.о.с. групп А, Б, Г, Д; по ГОСТ - Т1-Т5)');
            break;
        default:
            ShowError();
            return;
